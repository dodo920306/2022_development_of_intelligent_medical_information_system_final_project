...
def recognize_request(file_pth: str, mode: int):
    '''
    Mi2S ASR API
...
if __name__ == "__main__":
    ...
    if question=='哪些臺灣人曾經獲得諾貝爾獎':
        ...
        find = 1
        answer='1.將牛奶跟雞蛋以打蛋器充分混合。2.不需過篩直接倒入鬆餅粉在液體內。3.均勻攪拌不需要使勁地打，讓麵粉不會結塊即可。4.在平底鍋內放入一小塊奶油，如果是使用不沾鍋可以不放。 不過有放奶油的鬆餅香氣會更濃厚，緩緩倒入麵糊。5.接著轉小火煎3分鐘，翻面再煎2分鐘熟透就能起鍋。'
        ...
        find = 1
        answer='麥當勞: 小薯265 Kcal/ 中薯376 Kcal/ 大薯 529 Kcal。肯德基: 香酥脆薯 中份 185 Kcal'
        ...
        find = 1
        answer='1.除毛球機、毛球修剪器 這是最簡單也最方便的方法2.拿出寬版的透明膠帶，用黏性就可以將毛球黏起去除3.使用拋棄式的刮鬍刀，原理就與毛球修剪器相同，將毛球減下。'
        ...
        find = 1
        answer='上身：內搭淺色正式襯衫，外穿深色系（黑、深藍、灰）正式西裝外套。下身：配合上衣，穿深色西裝褲；女生可以選擇穿及膝西裝裙。鞋子：皮鞋或低跟鞋。'
